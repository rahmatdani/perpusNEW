                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        ...
                                        class="side-menu__label">Transaksi Peminjaman</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)">Transaksi Peminjaman</a></li>
                                    <li><a href="cards.html" class="slide-item"> Ajukan Peminjaman Buku</a></li>
                                    <li><a href="calendar.html" class="slide-item"> Approval Peminjaman</a></li>
                                    <li><a href="calendar.html" class="slide-item"> History Peminjaman</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="index.html"><i
                                        class="side-menu__icon fe fe-slack"></i><span
                                        class="side-menu__label">Aktivasi</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        class="side-menu__icon fe fe-grid"></i><span
                                        class="side-menu__label">Group / Kelas</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)">Group / Kelas</a></li>
                                    <li><a href="cards.html" class="slide-item"> Kelola Group / Kelas</a></li>
                                    <li><a href="calendar.html" class="slide-item"> Peminjaman Buku</a></li>
                                    <li><a href="calendar.html" class="slide-item"> Pengembalian Buku</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        class="side-menu__icon fe fe-users"></i><span
                                        class="side-menu__label">Anggota Perpustakaan</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)">Anggota Perpustakaan</a></li>
                                    <li><a href="cards.html" class="slide-item"> Approval Anggota</a></li>
                                    <li><a href="calendar.html" class="slide-item"> List Anggota</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="index.html"><i
                                        class="side-menu__icon fe fe-layers"></i><span
                                        class="side-menu__label">Buku Kunjungan</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        class="side-menu__icon fe fe-users"></i><span
                                        ...
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)">Report</a></li>
                                    <li><a href="cards.html" class="slide-item"> Peminjaman Harian</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        class="side-menu__icon fe fe-users"></i><span
                                        class="side-menu__label">Inventory</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
                                    <li class="side-menu-label1"><a href="javascript:void(0)">Inventory</a></li>
                                    <li><a href="cards.html" class="slide-item"> Master Buku</a></li>
                                    <li><a href="cards.html" class="slide-item"> Transakti Keluar / Masuk</a></li>
                                    <li><a href="cards.html" class="slide-item"> Stok Akhir</a></li>
                                    <li><a href="cards.html" class="slide-item"> Kartu Stok</a></li>
                                </ul>
                            </li>
                            {{-- <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                        class="side-menu__icon fe fe-package"></i><span
                                        class="side-menu__label">Aktivasi</span><i
                                        class="angle fe fe-chevron-right"></i></a>
                                <ul class="slide-menu">
